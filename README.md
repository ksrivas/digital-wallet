...
The solution is written in Python and attempt has been made to make it run with even the 2.5 version code.
...
A new file in `src` directory '"CheckFraud.py"' has been added and the run.sh script has been appropriately adjusted to call the write python code.
...
The concept of python dataframes and dictionaries/graphs is used to handle the input and output. A description of the main variables and functions
