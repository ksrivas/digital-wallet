...
3.) WARNINGMESSAGES; This is a list of potential messages from trusted to unverified for all cases.
This is a list and it is used by the function WriteFeature to generate the appropriate output written
to the output files.

The corresponding features can be checked by searching for string FEATURE 1, FEATURE 2 or FEATURE 3. Thats where
the comparison and output is done.
'''
